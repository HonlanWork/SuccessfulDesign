...
class AdminController extends Controller{
    ...
    public function promotion(){
        ...
        $this->count_paid = M('promotion')->where(array('contest_id'=>C('CONTESTID'), 'ispaied'=>1))->select();
        $this->count_paid = count($this->count_paid);
        $this->count_offline = M('promotion')->where(array('contest_id'=>C('CONTESTID'), 'ispaied'=>1, 'offline'>1))->select();
        $this->count_offline = count($this->count_offline);
